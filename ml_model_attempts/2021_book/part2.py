...
model_file_name = "convnet_from_scratch_with_augmentation.keras"
...
history = model.fit(
    train_dataset, epochs=45, validation_data=validation_dataset, callbacks=callbacks
)
...
# # this gets 87.4% accuracy on the test data, while it gets 83.5% on the dog/cat data
# # in the book. Data augmentation adds 3%, nice
